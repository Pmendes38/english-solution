...
export default function Hero() {
  return (
    <section id="hero" className="relative overflow-visible">
      ...
      <div className="hidden lg:block absolute top-[5%] right-[2%] w-[650px] h-[650px] bg-[var(--accent)] rounded-full blur-[80px] opacity-70 mix-blend-screen pointer-events-none" />
      {/* Grid texture */}
