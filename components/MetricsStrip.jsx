...
export default function MetricsStrip() {
  return (
    <section className="container-x pb-14 lg:pb-20">
      <Reveal>
        <div className="bg-[var(--bg-elevated)] border border-white/5 rounded-2xl px-8 lg:px-14 py-7 lg:py-8 grid grid-cols-2 lg:grid-cols-[1fr_auto_1fr_auto_1fr_auto_1fr] gap-y-6 gap-x-0 items-center">
            ...
            <div key={stat.label} className="contents">
              <div className="flex items-center gap-4 lg:px-6 first:lg:pl-0 last:lg:pr-0">
                ...
                <div className="leading-tight">
                  <div className="text-white font-serif font-bold text-xl lg:text-[26px]">
                    {stat.value}
                  </div>
